...
```
.size-30[![](assets/cover.png)]  
.size-20[![](assets/cover.png)]  
```
...
`<img src="assets/cover.png" style="width:20%;" class="fancyimage"/>`  
...
rmarkdown::render("nbis-slide-demo.Rmd")
# manually run this to convert HTML to PDF
#pagedown::chrome_print("nbis-slide-demo.html",output="nbis-slide-demo.pdf")
```
